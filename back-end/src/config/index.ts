...
export const SERVER_PORT = process.env.SERVER_PORT ? parseInt(process.env.SERVER_PORT, 10) : 7005; // Default port
...
console.log(`MongoDB URI: ${MONGO_URI.replace(/\/\/.*@/, '//****:****@')}`); // Avoid logging credentials if present
